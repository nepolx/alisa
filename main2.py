...
# def pause_w_search_recipe(req, res):
#     sessionStorage[user_id]["status"] = 'waiting_for_recipe'
#     pause(req, res)
#     search_recipe(req, res)
#
#
# def pause(req, res):
#     res['response']['text'] = 'Мне нужно пару секунд на поиск рецепта. Чтобы продолжить, скажи "Дальше".'
#     res['response']['buttons'] = [
#         {'title': 'Дальше',
#          'hide': True}]
#     return
#
#
# def waiting_for_recipe(req, res):
#     end(req, res)
#     if 'дальше' in req['request']['command']:
#         sessionStorage[user_id]["status"] = 'choice'
#         search_recipe_res(req, res)
#     else:
#         res['response']['text'] = 'Я тебя не понимаю. Если хочешь продолжить, скажи "Дальше".'
#     return
